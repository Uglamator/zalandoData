...
RAW_CSV = 'https://raw.githubusercontent.com/Uglamator/zalandoData/main/zalando_underwear_category.csv'
...
def dashboard_tab(df):
    ...
    with colA:
        ...
        st.plotly_chart(px.bar(x=pie_labels, y=pie_values, labels={'x': 'Brand', 'y': 'SKUs'}), use_container_width=True)
    with colB:
